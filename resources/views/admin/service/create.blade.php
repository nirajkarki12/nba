        ...
        <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" required class="form-control" id="title" name="title" value="{{ old('title') }}" placeholder="Title">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea id="detail" name="detail" rows="10" cols="80">{{ old('detail') }}</textarea>
              </div>
            </div>
