        ...
        <form class="form-horizontal" action="{{route('admin.video.update', $video->id)}}" method="POST" role="form">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" required class="form-control" id="title" name="title" value="{{ old('title') ?: $video->title }}" placeholder="Video Title">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="url" required class="form-control" id="url" name="url" value="{{ old('url') ?: $video->url }}" placeholder="Youtube URL">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" required class="form-control" id="videoId" name="videoId" value="{{ old('videoId') ?: $video->videoId }}" placeholder="Youtube Id">
              </div>
            </div>
          </div>
