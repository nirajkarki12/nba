        ...
        <form class="form-horizontal" action="{{route('admin.staff.store')}}" method="POST" enctype="multipart/form-data" role="form">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" required class="form-control" id="section" name="section" value="{{ old('section') }}" placeholder="Section">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" required class="form-control" id="room_no" name="room_no" value="{{ old('room_no') }}" placeholder="Room Number">
              </div>
            </div>
