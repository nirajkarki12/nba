        ...
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body box-profile">
                    ...
                    <img class="profile-user-img img-responsive img-circle" src="@if(Auth::guard()->user()->picture) {{Auth::guard()->user()->picture}} @else {{asset('images/placeholder.jpg')}} @endif" alt="User profile picture">
                    ...
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                            <b>Username</b> <a class="pull-right">{{Auth::guard()->user()->name}}</a>
                        </li>
                        <li class="list-group-item">
                            <b>Email</b> <a class="pull-right">{{Auth::guard()->user()->email}}</a>
                        </li>
                    ...
                    <div class="active tab-pane" id="adminprofile">
                        ...
                        <form class="form-horizontal" action="{{route('admin.profile.save')}}" method="POST" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="name"  name="name" value="{{Auth::guard()->user()->name}}" placeholder="Username">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="email" required value="{{Auth::guard()->user()->email}}" name="email" class="form-control" id="email" placeholder="Email">
                                </div>
                            </div>
